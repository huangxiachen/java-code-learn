<template>
  <div>
    ...
    <div class="content">
      <div class="card">
        <div class="card-header">创建试题</div>
        <div class="card-body">
              ...
              <div class="col-auto">
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
                    <div class="input-group-text">试题名称</div>
                  </div>
                  <input
                    type="text"
                    class="form-control"
...
export default {
  data() {
    return {
       ...
       myUrls: [
        ...
        { url: "/test/makeExecrise", name: "创建练习", status: false },
        { url: "/test/makeQuestion", name: "创建问卷", status: false },
        { url: "/test/makeTestQuestion", name: "创建试题", status: true },
  ...
  methods: {
    ...
    add() {
      ...
      if (this.brand === "") return alert("必须填写试题名称！");
