<template>
  <div>
    ...
    <div class="content">
      <div class="card">
        <div class="card-header">创建问卷</div>
        <div class="card-body">
              ...
              <div class="col-auto">
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
                    <div class="input-group-text">问卷名称</div>
                  </div>
                  <input
                    type="text"
                    class="form-control"
...
export default {
  data() {
    return {
       myUrls: [
        ...
        { url: "/test/makeQuestion", name: "创建问卷", status: true },
  ...
  methods: {
    ...
    add() {
      ...
      if (this.brand === "") return alert("必须填写问卷名称！");
