<template>
  <div>
    ...
    <div class="content">
      <div class="card">
        <div class="card-header">创建练习</div>
        <div class="card-body">
              ...
              <div class="col-auto">
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
                    <div class="input-group-text">练习名称</div>
                  </div>
                  <input
                    type="text"
                    class="form-control"
      ...
      <table class="table table-bordered table-hover table-striped">
        <thead>
          <tr>
            <th scope="col">序号</th>
            <th scope="col">练习名称</th>
            <th scope="col">练习状态</th>
...
export default {
  data() {
    return {
      // 动态生成侧边栏
     myUrls: [
        { url: "/test/manage", name: "考试管理", status: false },
        { url: "/test/maketest", name: "创建考试", status: false },
        { url: "/test/makeExecrise", name: "创建练习", status: true },
        { url: "/test/makeQuestion", name: "创建问卷", status: false },
        { url: "/test/makeTestQuestion", name: "创建试题", status: false },
        { url: "/test/maketest", name: "试卷导入", status: false },
      ],
      // 用户输入的练习名称
      brand: "",
      // nextId 是下一个，可用的 id
  ...
  methods: {
    ...
    add() {
      ...
      if (this.brand === "") return alert("必须填写练习名称！");
