<template>
  <div>
            ...
            <div class="modal-body">
              <div class="form-row align-items-center">
                <div class="col-auto">
                  <div class="input-group mb-2">
                    <div class="input-group-prepend">
                      <div class="input-group-text">补考名称</div>
                    </div>
                    <input
                      type="text"
                      class="form-control"
                ...
                <div class="col-auto">
                  <div class="input-group mb-2">
                    <div class="input-group-prepend">
                      <div class="input-group-text">补考人数</div>
                    </div>
                    <input
                      type="number"
                      class="form-control"
    ...
    <div class="content">
      <div class="card">
        <div class="card-header">补考</div>
        <div class="card-body">
          <div class="col-auto">
            <button type="button" @click="showAdd()" class="btn btn-primary mb-2">创建补考</button>
          </div>
        </div>
      </div>
      ...
      <table class="table table-bordered table-hover table-striped">
        <thead>
          <tr>
            <th scope="col">序号</th>
            <th scope="col">补考名称</th>
            <th scope="col">补考状态</th>
            <th scope="col">开始时间</th>
            <th scope="col">补考人数</th>
            <th scope="col">操作</th>
          </tr>
        </thead>
        <tbody>
...
export default {
  ...
  methods: {
    ...
    showAdd() {
      ...
      this.dialogTitle = "创建补考";
    },
    showUpdate(item, index) {
      this.isShowDialog = true;
      this.isAdd = false;

      this.dialogTitle = "更新补考";
      this.stu.id = item.id;
